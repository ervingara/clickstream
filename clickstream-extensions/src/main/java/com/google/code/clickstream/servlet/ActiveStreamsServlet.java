package com.google.code.clickstream.servlet;
...
//    private static final long serialVersionUID = 3134727194019463520L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Map<String, Clickstream> clickstreams = (Map<String, Clickstream>) this.getServletContext().getAttribute(ClickstreamListener.CLICKSTREAMS_ATTRIBUTE_KEY);
